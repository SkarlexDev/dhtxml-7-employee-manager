    ...
    private boolean dbDateCheck(List<Vacation> db, Vacation v) {
    	return db.stream()
				.anyMatch((dbv) -> Objects.equals(dbv.getEmployeeId(), v.getEmployeeId())
						&& ((dbv.getVacationFrom().isBefore(v.getVacationFrom()) || dbv.getVacationFrom().equals(v.getVacationFrom())))
						&& ((v.getVacationFrom().isBefore(dbv.getVacationTo()) || v.getVacationFrom().equals(dbv.getVacationTo())))
